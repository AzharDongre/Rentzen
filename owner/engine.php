...
function add_property(){
	...
	global $property_id,$country,$province,$zone,$district,$city,$vdc_municipality,
	$ward_no,$tole,$contact_no,$property_type,$estimated_price,$total_rooms,
	$bedroom,$living_room,$kitchen,$bathroom,$description,$latitude,$path,
	$p_photo,$property_photo_id,$longitude,$owner_id,$booked,$db;
	...
	$description=validate($_POST['description']);
        ...
        if(mysqli_num_rows($result1)>0)
      {
   	...
   	$sql = "INSERT INTO add_property(district,city,contact_no,property_type,
	   estimated_price,total_rooms,bedroom,living_room,kitchen,bathroom,description,owner_id) VALUES('$city','$vdc_municipality',
	   '$ward_no','$tole','$contact_no','$property_type','$estimated_price','$total_rooms','$bedroom','$living_room','$kitchen',
	   '$bathroom','$description','$owner_id')";
